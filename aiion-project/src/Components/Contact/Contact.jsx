...
//   <div className="container text-center">
//     <div className="contact-content p-4 bg-white shadow rounded">
//       <h1 className="contact-title mb-4 animate__animated animate__fadeInDown">Contact Us</h1>
...
<div className="contact-section bg-body-tertiary">
  <div className="container text-center">
    <div className="contact-content">
      ...
      <a href="mailto:m.algaiar@rgu.ac.uk" className="contact-btn btn btn-lg px-4 py-2 animate__animated animate__fadeInUp"><i className="fa-solid fa-envelope"></i> Contact Us</a>
    </div>
  </div>
</div>
